...
module decode(
    ...
    // Execute input 
    output reg [9:0]    control_bits_reg_o, // {branch_en_invert, branch_enable, immd_en, wb_en, mw_en, mr_en, alu_op[3:0]}
    ...
    always @(*) begin
        ...
        // branch enable
        lut_rd[8] = (opcode_reg_i[6:0] == `OPCODE_BRANCH);
    ...
    always @(*) begin
        rs1_addr_used = instr_reg_i[19:15];
    ...
    always @(*) begin
        case(lut_immd_type)
            ...
            'd4 : immd_val_nxt = 32'd0;                 // TBD
            'd5 : immd_val_nxt = 32'd0;                 // TBD
